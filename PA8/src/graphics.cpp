...
bool Graphics::Initialize(int width, int height)
{
  ...
  //Load Objects
  int ballCollidesWith = COL_BOARD | COL_CYL;// | COL_PAD;
  int boardCollidesWith = COL_BALL;
  int cylCollidesWith = COL_NOTHING;
  int paddleCollidesWith = COL_NOTHING;
